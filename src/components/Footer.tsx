...
const Footer = () => {
  ...
  return <footer className="bg-card/30 backdrop-blur-sm border-t border-border/30">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  <a href="https://wa.me/5563992476987" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
                    Orçamento
                  </a>
                </li>
              </ul>
