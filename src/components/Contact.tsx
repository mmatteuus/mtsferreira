        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="animate-slide-in">
              <h3 className="font-heading text-2xl font-semibold mb-8">Formas de Contato</h3>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className={`p-3 rounded-lg ${method.highlight ? 'bg-primary/20' : 'bg-muted/30'}`}>
                        <method.icon className={`h-5 w-5 ${method.highlight ? 'text-primary' : 'text-muted-foreground'}`} />
                      </div>
            ...
            <div className="animate-fade-in">
              <h3 className="font-heading text-2xl font-semibold mb-8">Como posso ajudar?</h3>
              ...
              <Card className="p-8 bg-gradient-primary/5 backdrop-blur-sm border-primary/20">
                <h4 className="font-heading text-xl font-semibold mb-4 text-center">
                  Orçamento Gratuito
                </h4>
          ...
          <div className="text-center">
            <Card className="p-6 bg-accent/5 backdrop-blur-sm border-accent/20 max-w-2xl mx-auto">
              <div className="flex items-center justify-center gap-3 mb-3">
                ...
                <h3 className="font-heading text-lg font-semibold">Emergências Técnicas</h3>
              </div>
